...
// async function main() {
//   try {
//     await fs.writeFile('./meu-arquivo.txt', 'Modificado com async await');
...
// para gerar o erro pode-se passar o primeiro parâmetro do 'fs.writeFile como uma string vazia, aí ele não identica caminho, nome e formato e dá error: await fs.writeFile('', 'Modificado com async await');
...
fs.writeFile('./meu-arquivo-teste1.txt', 'Eu estive aqui :eyes:', { flag: 'wx' })
  .then(() => {
