...
-- e o nome da rua onde o cliente mora. Essas informações podem ser 
...
-- clientes que moram no distrito da California e que contêm "rene" em 
-- seus nomes. As informações podem ser encontradas nas tabelas address 
-- e customer:
SELECT 
...
-- os clientes ativos. As informações podem ser encontradas na tabela 
-- address e customer:
SELECT 
...
-- titulo do filme , usando as tabelas actor , film_actor e film . 
