...
-- que exiba a união da tabela staff com a tabela actor, exibindo apenas 
-- o nome e o sobrenome . Seu resultado não deve excluir nenhum funcionário 
-- ao unir as tabelas:
SELECT 
...
-- 3) Monte uma query que exiba a união dos cinco últimos nomes da tabela 
-- actor, o primeiro nome da tabela staff e cinco nomes a partir da 15ª 
-- posição da tabela customer . Não permita que dados repetidos sejam 
...
-- 4) Você quer exibir uma lista paginada com os nomes e sobrenomes de 
-- todos os clientes e atores do banco de dados, em ordem alfabética. 
-- Considere que a paginação está sendo feita de 15 em 15 resultados e 
