...
// assert.strictEqual(expected, 3, 'Nove dividido por três é igual a três'); // não gera erro

// // assert.strictEqual(expected, 2, 'Nove dividido por três é igual a três'); // gera erro
