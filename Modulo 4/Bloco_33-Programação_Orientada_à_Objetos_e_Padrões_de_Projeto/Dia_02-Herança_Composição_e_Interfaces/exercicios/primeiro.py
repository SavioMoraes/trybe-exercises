# Exercício 1
# Lembra do exercício da TV que já abstraímos? Hoje vamos implementar
# ele, porém com algumas modificações. Veja o diagrama abaixo:
...
ligar_desligar - alterna o estado da TV entre ligado e
desligado ( True / False ).
"""
