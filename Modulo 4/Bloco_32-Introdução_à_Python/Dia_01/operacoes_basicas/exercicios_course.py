...
# Exercício 3: Teste e verifique o que acontece se você colocar um
# ponto e vírgula no final de uma instrução em Python.

# nome = 'Sávio Moraes'
# print(nome);

# Assim como em JavaScript, Python permite que você coloque um ponto
# e vírgula no final de uma instrução.

# Exercício 4: Suponha que o preço de capa de um livro seja 24,20, mas
# as livrarias recebem um desconto de 40%. O transporte custa 3,00 para
# o primeiro exemplar e 75 centavos para cada exemplar adicional. Qual é
# o custo total de atacado para 60 cópias? Escreva uma expressão que
...
# Exercício 6: Acesse e altere o primeiro elemento da lista
# para "Fundamentos".
...
# vistos acima. Depois, imprima a variável e confira se o retorno
# é: {'seu_nome'}.
...
# Exercício 11: Após uma consulta do banco de dados, temos linhas que
# contém nome, sobrenome e idade como: "Thiago", "Nobre", 29 . Que
# estrutura vista anteriormente seria recomendada dado que após esta
...
# dict é a estrutura mais adequada, pois conseguimos armazenar o elemento
# da lista como chave e a quantidade de vezes que ele aparece como valor
# da chave.
...
# multiplicação de todos os números predecessores maiores que 0. Por
# exemplo o fatorial de 5 é 120 pois 5! = 1 * 2 * 3 * 4 * 5 . Escreva
# um código que calcule o fatorial de um número inteiro.
...
# Note que usamos counter += 1 pra incrementar o contador -- não existe
# counter++ . Da mesma forma, poderíamos ter atualizado o resultado com
# a expressão result *= counter.
...
# cada avaliação. Após algumas mudanças estes valores precisam ser ajustados
# para avaliações de 0 a 100. Dado uma sequência de avaliações
# ratings = [6, 8, 5, 9, 10] . Escreva um código capaz de gerar as
# avaliações após a mudança. Neste caso o resultado deveria
# ser [60, 80, 50, 90, 100].
